...
<div class="container-fluid bg-primary deptHeader">
  <span class="deptName">Department of Electrical Engineering</span>
</div>
      ...
      <div class="navbar navbar-expand-sm bg-primary sidebar" role="navigation">
          ...
          <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav flex-column">
              <li class="active"><a href="ee.php?section=home">Home<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  About
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="ee.php?section=history">About</a>
                  <a class="dropdown-item" href="ee.php?section=history">History</a>
                  <a class="dropdown-item" href="ee.php?section=mission_vision">Vision And Mission</a>
                  <a class="dropdown-item" href="ee.php?section=hod_message">Programme Cordinator's Message</a>
                  <a class="dropdown-item" href="ee.php?section=contact">Contact Us</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="ee.php?section=pso">Program Specific Outcomes</a>
                  <a class="dropdown-item" href="ee.php?section=course_outcomes">Course Outcomes</a>
                  <a class="dropdown-item" href="ee.php?section=co_po_mapping">CO and PO Mapping</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown"> 
                  <a class="dropdown-item" href="ee.php?section=publication">Publication</a>
                   <a class="dropdown-item" href="ee.php?section=research">Projects</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="ee.php?section=faculty">Faculty</a>
                  <a class="dropdown-item" href="ee.php?section=staff">Technical Staff</a>
                </div>
              </li>
              <li class="active"><a href="ee.php?section=tech_events">Events<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Awards/Achivements
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="ee.php?section=awards_student">Students Awards</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="ee.php?section=labs">Laboratory</a>
                  <a class="dropdown-item" href="ee.php?section=library">Library</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="ee.php?section=alumni">Alumni</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../departments/ee/src/img/Carousel/slider1.jpg" alt="First slide">
          </div>
