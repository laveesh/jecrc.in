					...
					<div id="events_carausel1" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" src="../departments/events/src/img/hackathon/1.jpg" alt="First slide">
							</div>
							<div class="carousel-item ">
								<img class="d-block w-100" src="../departments/events/src/img/hackathon/2.jpg" alt="First slide">
							</div>
							<div class="carousel-item ">
								<img class="d-block w-100" src="../departments/events/src/img/hackathon/3.jpg" alt="First slide">
							</div>
							<div class="carousel-item ">
								<img class="d-block w-100" src="../departments/events/src/img/hackathon/4.jpg" alt="First slide">
							</div>
							<div class="carousel-item ">
								<img class="d-block w-100" src="../departments/events/src/img/hackathon/5.jpg" alt="First slide">
							</div>
						</div>
