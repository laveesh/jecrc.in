	...
	<div class="row sectionContent">
		...
		<div class="col-lg-6 col-md-12 mt-4">
			<div class="panel-body card">
				...
				<div class="row">
					<div class="col-md-3 pt-1 py-1" align="center">
						<img src="../departments/ece/src/img/people/faculty/sk_singh.jpg"class="img-responsive rounded-circle faculty-img" alt="faculty-image">
					</div>
					<div class="col-md-9 px-2">
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><strong>Educational Qualification</strong>: PhD</li>
			...
			<div class="panel-body card">
				...
				<div class="row">
					...
					<div class="col-md-9 px-2">
						...
						<li class="list-group-item"> Research Area:Nano Optics </li></ul>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="panel-body card">
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							...
							<li class="list-group-item"> Research Area:Ad hoc Network, MANET, VANET </li></ul>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel-body card">
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							...
							<li class="list-group-item"> Research Area:Photonic Crystal Fiber </li></ul>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item">Publication(s): 7</li>
							<li class="list-group-item"> Research Area:Communication, OFDM </li></ul>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel-body card">
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							...
							<li class="list-group-item"> Research Area:Renewable Energy Sources, Communication </li></ul>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item">Experience (in years): 8 </li>
								<li class="list-group-item">Publication(s): 4</li>
							<li class="list-group-item"> Research Area: Match Filter Design</li></ul>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item">Publication(s): 4</li>
							<li class="list-group-item"> Research Area:Signal Processing </li></ul>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item">Experience (in years): 6 </li>
								<li class="list-group-item">Publication(s): 7</li>
							<li class="list-group-item"> Research Area:Embedded Systems </li></ul>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel-body card">
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							...
							<li class="list-group-item"> Research Area:Communication System & Network </li></ul>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel-body card">
					...
					<div class="row">
						...
						<div class="col-md-9 px-2">
							...
							<li class="list-group-item"> Research Area: Photonics, Optoelectronics </li></ul>
						</div>
					</div>
				</div>
			</div>
