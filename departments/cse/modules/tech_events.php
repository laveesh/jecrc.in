				...
				<div id="events_carausel2" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/embryo/Picture1.png" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/embryo/Picture2.png" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/embryo/Picture3.png" alt="Third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/embryo/Picture4.png" alt="Fourth slide">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel3" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/enlightment/Picture1.png" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/enlightment/Picture2.png" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/enlightment/Picture3.png" alt="Third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/enlightment/Picture4.png" alt="Fourth slide">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel4" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/HardwareAssembling/Picture1.png" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/HardwareAssembling/Picture2.png" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/HardwareAssembling/Picture5.png" alt="Third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/HardwareAssembling/Picture4.png" alt="Fourth slide">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-12">
				<div id="events_carausel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/InternationalWorkshop/Picture1.png" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/InternationalWorkshop/Picture2.png" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/InternationalWorkshop/Picture3.png" alt="third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/InternationalWorkshop/Picture4.png" alt="fourh slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/cse/src/img/Events/InternationalWorkshop/Picture5.png" alt="fifth slide">
						</div>
