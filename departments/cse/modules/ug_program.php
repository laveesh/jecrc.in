<div class="container card section">
	...
	<div class="card-body sectionContent">
		...
		<ol class="sectionList">
			<li>To provide students with the fundamentals of Engineering Sciences with more emphasis in Computer Science & Engineering by way of analyzing and exploiting engineering challenges.</li>
			<li>To train students with good scientific and engineering knowledge so as to comprehend, analyze, design, and create novel products and solutions for the real life problems.</li>
			<li>To inculcate professional and ethical attitude, effective communication skills, teamwork skills, multidisciplinary approach, entrepreneurial thinking and an ability to relate engineering issues with social issues.</li>
			<li>To provide students with an academic environment aware of excellence, leadership, written ethical codes and guidelines, and the self-motivated life-long learning needed for a successful professional career.</li>
			<li>To prepare students to excel in Industry and Higher education by Educating Students along with High moral values and Knowledge.</li>
		</ol>
		...
		<ol class="sectionList">
			...
			<li><strong>Project management and finance: </strong>Demonstrate knowledge and
		...
		<ul class="sectionList">
			<li>Ability to interpret and analyze network specific and cyber security issues in real world environment.</li>
			<li>Ability to design and develop Mobile and Web-based applications under realistic constraints.</li>
		</ul>
	</div>
</div>