...
<div class="container">
	...
	<section class="section">
		<div class="sectionHeading"> International Conference on Mathematical Modeling and Computing-2018</div>
		<div class="row">
				...
				<div id="events_carausel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/as/src/img/awards/ICMMC/ICMMC1.png" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/as/src/img/awards/ICMMC/ICMMC2.png" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/as/src/img/awards/ICMMC/ICMMC3.png" alt="Second slide">
						</div>
			...
			<div class="col-md-9 col-sm-12 sectionContent">
				<ol class="sectionList px-4">
					<li><strong>Date of the event:</strong>April 6, 2018</li>
					<li><strong>Venue:</strong> Auditorium</li>
					<li><strong>Objectives:</strong>
						<p>Department of Mathematics organized an International conference on Mathematical Modeling & Computing on April, 6-7 2018 at JECRC. The conference covered the different tracks including Mathematical Modeling, Computing, Statistics, Image Processing, Relativity & Cosmology, Fuzzy Logic, Fluid Dynamics, Fractional calculus, Integral Transforms etc. 
                        The Conference started with Inauguration in the college Auditorium at 9:30 am on 6th April 2018, where speakers and guests were welcomed with mementoes as token of gratitude towards them.</p>
                       <ul>
                        The Key Note Speakers for the conference were:
                       <li> Prof. P. Chaturani(Retd. from IIT Mumbai)</li>
                       <li> Prof. Peeyush Chandra(Retd. from IIT Kanpur)</li>
                       <li>Prof. K.S. Nisar(PSAU, Saudi Arabia, Delivered a talk on skype)</li>
                       </ul>
                        Total 5 sessions of paper presentations held during two days of the conference ICMMC-18. 
                        Session chairs for the individual session are Prof. S.P Gupta(Retd. Prof. from UOR), Prof. Swati Chande(IIIM , Jaipur), Prof. Paresh Vyas(UOR, Jaipur), Dr. Ritu Goyal(MNIT, Jaipur), Dr. Pranay Goswami(Ambedkar University, Delhi)
                    </li>
					<li><strong>Outcome:</strong>
						<p>The conference received about 100 research papers out of which 40 were selected for presentation after undergoing rigorous review process. Board of reviewers of ICMMC include experts from India and abroad. Participants from all over the country presented their papers in front of the expert panel and session chairs followed by small question answer round which helped participants to improve their reserch. 
						</p>
						<p>
...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9 col-sm-12 sectionContent px-4">
				<ol class="sectionList">
					<li><strong>Date:</strong> 17th to 31th  January 2018 and 19th Feb to 28th Feb 2018</li>
					<li><strong>Venue:</strong> C - Block auditorium</li>
					<li><strong>Objectives:</strong>
						<ul class="sectionList">
							<li>To aware research scholars, students and faculty members about the</li>
							<li>Brief Introduction of Red Hat. Various career opportunists available in the market apart from Networking jobs</li>
							<li>Market significance of red Hat certification.  Career opportunities with Red Hat certifications.</li>
						</ul>
					</li>
	...
	<section class="section">
		<div class="sectionHeading">Spy Robotic Workshop by TechiNest Pvt. Ltd.</div>
		<div class="row">
			<div class="col-md-3 col-sm-12">
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel4" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/induction/1.jpg" alt="induction">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/induction/2.jpg" alt="induction">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel5" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/smart-india-hackathon/1.jpg" alt="Smart-India-Hackathon">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/smart-india-hackathon/2.jpg" alt="Smart-India-Hackathon">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/smart-india-hackathon/3.jpg" alt="Smart-India-Hackathon">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel6" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/J-Techtrix/1.jpg" alt="J-Techtrix">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/J-Techtrix/2.jpg" alt="J-Techtrix">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/J-Techtrix/3.jpg" alt="J-Techtrix">
						</div>
					</div>
			...
			<div class="col-md-9 col-sm-12 sectionContent px-4">
				...
				<ol class="sectionList">
					<li><strong>Date of the event:</strong> 5<sup>th</sup> and 6<sup>th</sup> April 2017</li>
			...
			<div class="col-md-9 col-sm-12 sectionContent px-4">
				...
				<ol class="sectionList">
					<li><strong>Date of the event:</strong> 8 <sup>th</sup>April 2017</li>
									<li><strong>Venue:</strong> B-Block, Department of Electronics and Communication  Engineering</li>
		...
		<div class="row">
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel8" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/1.jpg" alt="National Conference">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/2.jpg" alt="National Conference">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/3.jpg" alt="National Conference">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/4.jpg" alt="National Conference">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/5.jpg" alt="National Conference">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/NC/6.jpg" alt="National Conference">
						</div>
					</div>
			...
			<div class="col-md-3 col-sm-12">
				<div id="events_carausel9" class="carousel slide" data-ride="carousel">
					<ol class="carousel-indicators">
						...
						<li data-target="#events_carausel9" data-slide-to="3"></li>
					</ol>
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/industrial-visit/1.jpg" alt="Industrial-Visit">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/industrial-visit/2.jpg" alt="Industrial-Visit">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/industrial-visit/3.jpg" alt="Industrial-Visit">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" src="../departments/ece/src/img/Events/industrial-visit/4.jpg" alt="Industrial-Visit">
						</div>
					</div>
