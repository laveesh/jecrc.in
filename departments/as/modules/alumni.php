<section class="section container">
	...
	<div class="row sectionContent">
		<div class="col-md-12 mt-4">
			<div class="panel-body card">
				<div class="card-header text-center"><h4>V. K. Jaiswal, Scientist, DEAL, Defence R and D Organisation</h4></div>
				<div class="row">
					<div class="col-md-3 pt-1 py-1" align="center">
						<img src="../departments/ece/src/img/alumni/vkjaiswal.jpg"	class="img-responsive rounded-circle w-75" alt="faculty-image">
					</div>
	...
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Vipul Tiwari, Network Engineer, Ericsson</h4></div>
			<div class="row">
				<div class="col-md-3 pt-1 py-1" align="center">
					<img src="../departments/ece/src/img/alumni/vipul.jpg"	class="img-responsive rounded-circle w-75 " alt="faculty-image">
				</div>
				<div class="col-md-9 px-2">
					<div class="sectionContent">
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Shalini Agarwal , Software Developer, Accenture</h4></div>
			<div class="row">
				<div class="col-md-3 pt-1 py-1" align="center">
					<img src="../departments/ece/src/img/alumni/shalini.jpg"	class="img-responsive rounded-circle w-75" alt="faculty-image">
				</div>
				<div class="col-md-9 px-2">
					<div class="sectionContent">
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Neha Kumari , Software Developer, TCS </h4></div>
			<div class="row">
				<div class="col-md-3 pt-1 py-1" align="center">
					<img src="../departments/ece/src/img/alumni/neha.jpg"	class="img-responsive rounded-circle w-75" alt="faculty-image">
				</div>
				<div class="col-md-9 px-2">
					<div class="sectionContent">
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Tanuj Kothari  Software Developer, Accenture</h4></div>
			<div class="row">
				<div class="col-md-3 pt-1 py-1" align="center">
					<img src="../departments/ece/src/img/alumni/tanuj.jpg"	class="img-responsive rounded-circle w-75" alt="faculty-image">
				</div>
				<div class="col-md-9 px-2">
					<div class="sectionContent">
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Tapan Soni, Lead UI/UX Designer, Cashless Technologies</h4></div>
			<div class="row">
				<div class="col-md-3 pt-1 py-1" align="center">
					<img src="../departments/ece/src/img/alumni/tapan.jpg"	class="img-responsive rounded-circle w-75" alt="faculty-image">
				</div>
				<div class="col-md-9 px-2">
					<div class="sectionContent">
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Suwarana Sant, AP, Career Point </h4></div>
...
<div class="row sectionContent">
	<div class="col-md-12 mt-4">
		<div class="panel-body card">
			<div class="card-header text-center"><h4>Veerangana, Network Engineer, Ericsson</h4></div>
