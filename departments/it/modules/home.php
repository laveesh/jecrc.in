        ...
        <div class="card-body">
          ...
          <ul class="list-group list-group-flush text-primary">
            <li class="list-group-item">
              IT HACKATHON was conducted by IT department in November 2017
            </li>
            <li class="list-group-item">
              IT IDEATHON was conducted by IT department in October 2017
            </li>
            <li class="list-group-item">
              SIP-EXPO organised in November 2017
            </li>
