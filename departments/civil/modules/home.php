    ...
    <div class="col-md-6">
      <section class="section container card">
        ...
        <div class="sectionContent card-body">
          <div class="row">
            <div class="col-md-4 py-2"><a href="../departments/civil/src/newsletters/constructo-1.pdf" class="btn btn-block btn-lg btn-primary" download>Vol-1 Issue-1</a></div>
            <div class="col-md-4 py-2"><a href="../departments/civil/src/newsletters/constructo-2.pdf" class="btn btn-block btn-lg btn-primary" download>Vol-1 Issue-2</a></div>
            <div class="col-md-4 py-2"><a href="../departments/civil/src/newsletters/constructo-3.pdf" class="btn btn-block btn-lg btn-primary" download>Vol-2 Issue-1</a></div>
          </div>
          <hr>
          <p class="py-2 px-3">
