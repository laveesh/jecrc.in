...
<div class="container-fluid bg-primary deptHeader">
  <span class="deptName">Department of Civil Engineering</span>
</div>
    ...
    <div class="col-sm-2 sidebarContainer">
      <div class="navbar navbar-expand-sm bg-primary sidebar" role="navigation">
          <div class="container-fluid">
              ...
              <li class="active"><a href="civil.php?section=home">Home<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="civil.php?section=labs">Laboratory</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../departments/civil/src/img/Carousel/slider5.jpg" alt="First slide" width="1400" height="500">
          </div>
          <div class="carousel-item">
            <img src="../departments/civil/src/img/Carousel/slider6.jpg" alt="Second slide" width="1400" height="500">
          </div>
          <div class="carousel-item">
            <img   src="../departments/civil/src/img/Carousel/slider7.jpg" alt="Third slide" width="1400" height="500">
          </div>
          <div class="carousel-item">
            <img  src="../departments/civil/src/img/Carousel/slider8.jpg" alt="Fourth slide" width="1400" height="500">
          </div>
