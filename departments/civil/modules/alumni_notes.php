...
<div class="sectionContent">
	<div class="card">
		...
		<div class="row">
			<div class="col-md-2">
				<img height="200" src="../departments/civil/src/img/alumni/radhika.jpg">
			</div>
...
<div class="sectionContent">
	<div class="card">
		...
		<div class="row">
			<div class="col-md-2">
				<img height="200" src="../departments/civil/src/img/alumni/kalpit.JPG">
			</div>
			<div class="col-md-10 text-center">
...
<div class="sectionContent">
	<div class="card">
		...
		<div class="row">
			<div class="col-md-2">
				<img height="200" src="../departments/civil/src/img/alumni/nikhil.jpg">
			</div>
			<div class="col-md-10 text-center">
				<p class="px-3">The college days at JECRC were filled with joy and enthusiasm. This was due to the dedicated college management and faculty of CE department. The practical experience gained through industrial tours and visits helped us to evolve as a civil engineer. I feel privileged to be a JECRC Alumni.</p>
			</div>
		</div>
	</div>
</div>
...
<div class="sectionContent">
		...
		<div class="row">
			<div class="col-md-2">
				<img height="200" src="../departments/civil/src/img/alumni/anshul.jpg">
			</div>
			<div class="col-md-10 text-center">
