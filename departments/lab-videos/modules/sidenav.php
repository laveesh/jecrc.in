...
<div class="container-fluid bg-primary deptHeader">
  <span class="deptName">Laboratories Videos</span>
</div>
        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav flex-column">
              ...
              <li class="active"><a href="lab-videos.php?section=me">ME<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="lab-videos.php?section=ece">ECE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="lab-videos.php?section=ce">CE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="lab-videos.php?section=ee">EE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
            </ul>
          </div>
        </div>
      </div>
