...
<div class="container-fluid bg-primary deptHeader">
  <span class="deptName">Academics</span>
</div>
    ...
    <div class="col-sm-2 sidebarContainer">
      <div class="navbar navbar-expand-sm bg-primary sidebar" role="navigation">
          <div class="container-fluid">
              ...
              <li class="active"><a href="academics.php?section=home">Home<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="academics.php?section=programs">Departments & Programms<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
            	</ul>
      				</li>
      			</ul>
      		</div>
