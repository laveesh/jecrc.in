	...
	<div class="row sectionContent">
		<div class="col-lg-6 col-md-12 mt-4">
			<div class="panel-body card">
				<div class="card-header text-center"><h4>Ms. Priyanka Shukla</h4></div>
				<div class="row">
					<div class="col-md-3 pt-1 py-1" align="center">
						<img src="../departments/alumni/src/img/team/priyanka.jpg"class="img-responsive rounded-circle faculty-img" alt="faculty-image">
					</div>
					<div class="col-md-9 px-2">
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><strong>Educational Qualification</strong>: MBA</li>
							<li class="list-group-item"><strong>Designation</strong>: Head Alumni Relations</li>
							<li class="list-group-item"><strong>Email</strong>: priyanka.shukla@jecrc.ac.in</li>
							<li class="list-group-item"><strong>Contact</strong>: 7791039850</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-6 col-md-12 mt-4">
			<div class="panel-body card">
				<div class="card-header text-center"><h4>Mr. Kumar Niraj</h4></div>
				<div class="row">
					<div class="col-md-3 pt-1 py-1" align="center">
						<img src="../departments/alumni/src/img/team/neeraj.jpg"	class="img-responsive rounded-circle faculty-img" alt="faculty-image">
					</div>
					<div class="col-md-9 px-2">
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item"><strong>Email</strong>: niraj.ar@jecrc.ac.in</li>
							<li class="list-group-item"><strong>Contact</strong>: 7611801937</li>
						</ul>
					</div>
				</div>
			</div>
