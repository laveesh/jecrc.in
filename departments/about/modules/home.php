<section class="section container">
	...
	<div class="sectionContent">
		<blockquote>
			<strong>A pioneer in higher learning in the state of Rajasthan, the JECRC Foundation is redefining the academic space with research oriented education that puts excellence above anything else.</strong>
		</blockquote>
		<p>
			The National Society for Education Research and Development
			(NSERD) was registered in the year 1999 in Jaipur with the major
			objective of providing quality education and research
			environment in Rajasthan. It established its first college, Jaipur
			Engineering College & Research Centre (JECRC) in Jaipur, in the
			year 2000. Encouraged by its splendid achievements and
			overwhelming public patronage, it ventured into establishing
			second college, UDML College of Engineering (which is known as
			JECRC UDML College of Engineering) in the year 2007.
		</p>
		<p>
			The JECRC Foundation having 18 year of existence, is
			amongst the most reputed educational groups in Higher and
			Technical Education in North India which has 2 large campuses
		...
		<p>
			JECRC has become the most sought-after institutions for admissions as evident by the REAP admission! Patterns. The JECRC Foundation has now become a brand name in professional education in Rajasthan. 
		</p>
	</div>
