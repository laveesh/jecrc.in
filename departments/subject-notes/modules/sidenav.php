...
<div class="container-fluid bg-primary deptHeader">
  <span class="deptName">Subject Notes</span>
</div>
        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav flex-column">
              ...
              <li class="active"><a href="subject-notes.php?section=ece">ECE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="subject-notes.php?section=ce">CE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
              <li class="active"><a href="subject-notes.php?section=ee">EE<span class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
            </ul>
          </div>
        </div>
      </div>
