        ...
        <ul class="navbar-nav mr-auto center-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="pages/subject-notes.php?section=fy">Subject Notes</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="pages/as.php?section=home">Applied Science</a>
          ...
          <div class="sectionContent px-4">
            <marquee direction="up" behavior="scroll" height="500" scrollamount="6" id="marq">
              <ul class="sectionList list-group news">
                <li class="list-group">Aashayein Celebrated annual day on February 22, 2019</li>
                ...
                <li class="list-group-item">JECRC students make World Record and got there names wrritten in Golden Book of World Record on 20 August</li>
                <li class="list-group-item">2-days workshop on Aptitude skills and Personality Development on 17 August</li>
                <li class="list-group-item">JECRC Foundation ans Suhasini in association with P&G brings free hygiene products for female students and staff on 14 August</li>
                <li class="list-group-item">9 Students selected for Educational Tour of USA by Rajasthan Government on 11 August</li>
                <li class="list-group-item">15 days induction program for 2nd year conducted by IT- Department from 2-July to 18-July</li>              </ul>
              </marquee>
            </div>
          </div>
        </div>
